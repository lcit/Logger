/*	=========================================================================
	...
	Company: 
	Filename: test_sFIFO.cpp
	Last modifed:   10.07.2016 by Leonardo Citraro
	Description:	Test of the thread-safe sFIFO. In the first part we just test
...
class ITEM {
	public:
		...
		~ITEM(){}
		float get_size_seconds(){return (float)1.2;}
};
...
int main(){
	...
	cout << "Fifo size:" << fifo.size() << " [s]" << endl;
